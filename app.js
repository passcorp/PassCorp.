    ...
    <footer class="footer">
      ...
      <div class="footer-bottom">
        ...
        <div style="display:inline-flex;align-items:center;gap:18px;">
          <a href="quotation.html?secure=1" target="_blank" style="display:inline-flex;align-items:center;gap:5px;cursor:pointer;color:#3b82f6;font-weight:600;">${icon("box",13)} Quotation Generator</a>
