    ...
    <footer class="footer">
      ...
      <div class="footer-bottom">
        ...
        <div style="display:inline-flex;align-items:center;gap:14px;">
          <a href="quotedesk.html?v=v_print_fit_v11_1788947307" target="_blank" style="display:inline-flex;align-items:center;cursor:pointer;opacity:0.8;transition:opacity 0.2s;" onmouseover="this.style.opacity='1'" onmouseout="this.style.opacity='0.8'" title="QuoteDesk Pro"><img src="assets/snowflake-white.png" alt="QuoteDesk" style="width:14px;height:14px;object-fit:contain;display:block;" /></a>
